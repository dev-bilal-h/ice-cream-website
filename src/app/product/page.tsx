    ...
    <div className="py-10 px-4 text-center bg-gray-50">
      ...
      <div className="mt-8 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        {classicProducts.map((product) => (
          ...
          >
            {/* Product Image */}
            <div className="relative w-64 h-52 bg-pink-100 rounded-lg mx-auto mt-4 flex items-center justify-center">
              <Image
                src={product.image}
                alt={product.name}
                fill
      ...
      <div className="mt-8 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        {bestSellers.map((product) => (
          ...
          >
            {/* Product Image */}
            <div className="relative w-64 h-52 bg-red-100 rounded-lg mx-auto mt-4 flex items-center justify-center">
              <Image
                src={product.image}
                alt={product.name}
                fill
